...
exports.save = async function (req, res) {
    try {
        const result = await USERS.save(req);
...
exports.read = async function (req, res) {
    try {
        const result = await USERS.read(req);
        send_response(res, result);
    } catch (error) {
...
exports.authenticate = async function (req, res) {
    try {
        const result = await USERS.authenticate(req);
        send_response(res, result);
    } catch (error) {
...
exports.update_password = async function (req, res) {
    try {
        const result = await USERS.update_password(req);
        send_response(res, result);
    } catch (error) {
        handle_controller_error(res, error, 'update_password');
    }
};
 ...
 * @returns {Promise<void>}
 */
exports.regenerate_api_key = async function (req, res) {
    try {
        const result = await USERS.regenerate_api_key(req);
        send_response(res, result);
    } catch (error) {
        handle_controller_error(res, error, 'regenerate_api_key');
    }
};
...
exports.delete_account = async function (req, res) {
    try {
        const result = await USERS.delete_account(req);
        send_response(res, result);
    } catch (error) {
        handle_controller_error(res, error, 'delete_account');
    }
};