        ...
        <div className="container">
            <div className="row margin-bottom-60">
                ...
                <div className="col-lg-5 col-md-5 tm-footer-div">
                    ...
                    <p className="margin-top-15">Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim.
                        Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut
                        metus varius laoreet.</p>
                    <p className="margin-top-15">Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem.
    ...
    <div>
        <div className="container">
            <div className="row tm-copyright">
                <p className="col-lg-12 small copyright-text text-center">Copyright &copy; 2084 Your Cafe House (ICT4510
                    Final Project Example)</p>
            </div>
        </div>
    </div>
